...
public class CustomThreadFactoryTest implements ThreadFactory {
    //thread properties
    long stackSize;
    String pattern;
    ClassLoader ccl;
    ...
    public CustomThreadFactoryTest(){
        ...
        pattern(stack.length>1?getOuterClassName(stack[1].getClassName()):"CustomThreadFactory", true);
    }
    ...
    public CustomThreadFactoryTest pattern(String patten, boolean appendFormat){
        assertConfigurable();
        if (appendFormat){
    ...
    public CustomThreadFactoryTest daemon(boolean daemon){
        assertConfigurable();
        this.daemon = daemon;
        return this;
    }

    public CustomThreadFactoryTest priority(int priority){
        assertConfigurable();
    ...
    public CustomThreadFactoryTest stackSize(long stackSize){
        assertConfigurable();
    ...
    public CustomThreadFactoryTest threadGroup(ThreadGroup group){
        assertConfigurable();
        this.group= group;
        return this;
    }

    public CustomThreadFactoryTest exceptionHandler(UncaughtExceptionHandler exceptionHandler){
        assertConfigurable();
        this.exceptionHandler= exceptionHandler;
        return this;
    }

    public CustomThreadFactoryTest wrapRunnable(boolean wrapRunnable){
        assertConfigurable();
        this.wrapRunnable= wrapRunnable;
        return this;
    }

    public CustomThreadFactoryTest ccl(ClassLoader ccl){
        assertConfigurable();
        this.ccl = ccl;
        return this;
    }
